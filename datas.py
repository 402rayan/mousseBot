...
all_synergies = [
    ...
    (313, "Maître des 4 éléments", "DEF", 0.45, "Les Maitres de tous les elements sont des individus qui peuvent maitriser tous les elements pour combattre leurs ennemis.", image_temporaire, "#00000"),
...
all_link_synergies = {
    ...
    129 : ["Smoker","Morel Mackernasey","Zabuza Momochi","Muichiro Tokito","Izuku Midoriya","Mei Terumi","Weather Report","Rangiku Matsumoto"], # Maître du Brouillard
