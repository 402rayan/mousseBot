...
def image_temporaire():
    return random.choice(['https://i.imgur.com/I5FU4lB.png','https://i.imgur.com/H9CetGc.png','https://i.imgur.com/wqFQ0by.png','https://i.imgur.com/BOcSeri.png'])
...
all_characters_templates = {
           ...
           # Personnages F
            ...
            ("Charlotte Linlin", "X", "https://i.imgur.com/tPjCbUc.gif", 1005, 910, 1000),
            ...
            ("Shuhei Hisagi", "A", 'https://i.imgur.com/rkQNMQX.gif', 415, 435, 420),
            ...
            ('Yo Shindo', 'C', 'https://i.imgur.com/I7uLCYw.jpeg', 285, 285, 270) ,
            ...
            "Jujutsu Kaisen" : [  # ✅
            # Personnages X
            ("Ryomen Sukuna", "X", "https://i.imgur.com/sALgfhD.gif", 1000, 1100, 1050),
            ("Satoru Gojo", "X", "https://i.imgur.com/NC01s1K.gif", 999, 1050, 999),
            ...
            # Personnages SS
            ("Johnny Joestar", "SS", "https://i.imgur.com/cgLbkoE.gif", 750, 800, 800),
            ...
            ("Muzan Kibutsuji", "X", "https://i.imgur.com/zXvC5Uj.gif", 940, 950, 930),
            ...
            # Personnages D
            ("Michiko Tendo", "D", "https://i.imgur.com/vsE0OlY.png", 145, 165, 120),
            ("Yutaro Kurose", "D", "https://i.imgur.com/Ks0x4qp.png", 145, 165, 125),
...
all_synergies = [
    ...
    (29, "Maitre du Feu", "ATK", 0.25, "Les Maitres du Feu sont des personnages qui maîtrisent le feu.", image_temporaire(), "#FFA500"),
    (30, "Maitre de l'Eau", "ATK", 0.25, "Les Maitres de l'Eau sont des personnages qui maîtrisent l'eau.", image_temporaire(), "#0000FF"),
    (31, "Maitre de la Terre", "ATK", 0.25, "Les Maitres de la Terre sont des personnages qui maîtrisent la terre.", image_temporaire(), "#800080"),
    (32, "Maitre de l'Air", "ATK", 0.25, "Les Maitres de l'Air sont des personnages qui maîtrisent l'air.", image_temporaire(), "#FF0000"),
    (33, "Maitre de la Foudre", "ATK", 0.35, "Les Maitres de la Foudre sont des personnages qui maîtrisent l'éclair.", image_temporaire(), "#FFA500"),
    (34, "Maitre de la Glace", "ATK", 0.35, "Les Maitres de la Glace sont des personnages qui maîtrisent la glace.", image_temporaire(), "#0000FF"),
    (36, "Maitre de la Lave", "ATK", 0.45, "Les Maitres de la Lave sont des personnages qui maîtrisent la lave.", image_temporaire(), "#FF0000"),
    (37, "Maitre du Bois", "ATK", 0.50, "Les Maitres du Bois sont des personnages qui maîtrisent le bois.", image_temporaire(), "#FFA500"),
    (38, "Maitre du Vent", "ATK", 0.50, "Les Maitres du Vent sont des personnages qui maîtrisent le vent.", image_temporaire(), "#0000FF"),
    (39, "Maitre du Sable", "ATK", 0.50, "Les Maitres du Sable sont des personnages qui maîtrisent le sable.", image_temporaire(), "#800080"),
    ...
    (50, "Zeppeli", "ATK", 0.40, "Les Zeppelis sont une famille de Maitres de l'Onde qui combattent les vampires.", image_temporaire(), "#0000FF"),
    ...
    (53, "Maitre du Temps", "HP", 0.5, "Les Maitres du Temps sont des personnages qui peuvent contrôler le temps.", image_temporaire(), "#FFA500"),
    (54, "Maitre de l'Explosion", "ATK", 0.5, "Les Maitres de l'Explosion sont des personnages qui peuvent créer des explosions.", image_temporaire(), "#0000FF"),
    ...
    (63, "Equipage de Big Mom", "HP", 0.45, "L'equipage de Charlotte Linlin est un groupe de pirates dirige par Charlotte Linlin.", image_temporaire(), "#FF0000"),
    ...
    (78, "Tueur de Démon", "ATK", 0.35, "Les Pourfendeurs de demons sont une organisation secrete qui lutte contre les demons.", image_temporaire(), "#800080"),
    ...
    (86, "Lune", "ATK", 0.50, "Les Lunes sont des demons puissants qui servent Muzan Kibutsuji.", image_temporaire(), "#800080"),
    (87, "Brando", "ATK", 0.50, "Les Brando sont une famille de vampires qui cherchent à dominer le monde.", image_temporaire(), "#FF0000"),
    (88, "Maitre de la Gravité", "ATK", 0.50, "Les Maitres de la Gravite sont des personnages qui peuvent contrôler la gravite.", image_temporaire(), "#FFA500"),
    ...
    (129, "Maitre du Brouillard", "DEF", 0.45, "Les Maitres du Brouillard sont des ninjas qui peuvent manipuler le brouillard pour attaquer leurs ennemis.", image_temporaire(), "#00000"),
    ...
    (296, "Maitre des Fils", "DEF", 0.45, "Les Maitres des Fils sont des individus qui maitrisent l'art des fils pour combattre leurs ennemis.", image_temporaire(), "#00000"),
    ...
    (307, "Dernier Survivant de son Clan", "DEF", 0.45, "Les Derniers Survivants de leur Clan sont des individus qui ont perdu leur famille et qui sont les seuls survivants de leur clan.", image_temporaire(), "#00000"),
    (308, "Utilisateur de l'Infini", "ATK", 0.45, "Les Utilisateurs de l'Infini sont des individus qui utilise l'infini en tant que pouvoir.", image_temporaire(), "#00000"),
    (309, "Provocateur de Séisme", "ATK", 0.45, "Les Utilisateurs du Pouvoir Sismique sont des individus qui peuvent creer des tremblements de terre pour attaquer leurs ennemis.", image_temporaire(), "#00000"),
    (310, "Détenteur d'Excalibur", "ATK", 0.45, "Les Detenteurs d'Excalibur sont des individus qui possedent l'epee legendaire Excalibur pour combattre leurs ennemis.", image_temporaire(), "#00000"),
    (311, "Transformation du Dernier Recours", "DEF", 0.45, "Les Derniers Recours sont des individus qui utilisent leur dernier souffle pour proteger leur famille et leur pays.", image_temporaire(), "#00000"),
...
all_link_synergies = {
    ...
    310 : ["Arthur Pendragon"], # Détenteur d'Excalibur
    309 : ["Edward Newgate","Marshall D. Teach","Yo Shindo"], # Pouvoir Sismique
    308 : ["Satoru Gojo","Merlin"], # Utilisateur de l'Infini
    306 : ["Kenpachi Zaraki","Retsu Unohana"], # Kenpachi
    305 : ["Korra","Aang"], # Avatar
    304 : ["Toppo","Jiren"], # Pride Troopers
    303 : ["Karuto Zoldyck","Doma","Temari"], # Utilisateur d'Eventail
    302 : ["Endeavor", "Ging Freecss","Son Goku","Dario Brando","Grisha Yeager","Van Hoheinheim","Diavolo","Ozai"], # Père Indigne
    301 : ["Kisuke Urahara","Yoruichi Shihoin"], # Boutique d'Urahara
    300 : ["Renji Abarai", "Ichigo Kurosaki","Shinji Hirako","Shuhei Hisagi","Toshiro Hitsugaya","Gin Ichimaru","Sajin Komamura","Ginrei Kuchiki","Rukia Kuchiki","Isshin Kurosaki","Mayuri","Kaname Tosen"], # Expérimenté en Shunpo
    299 : ["Mahoraga"], # Familier
    298 : ["Crocodile","Mahito","Franklin","Kishibe"], # Recousu
    #297 : ["Kento Nanami","Rui","Zabuza","Haku","C-18","Baggy","Brogy","Dorry","Sanji","Yoruichi Shihoin","Eren"], # Personnage de !histoire
    296 : ["Jolyne Kujo","Machi","Don Quichotte Doflamingo","Sasori","Chiyo","Kankuro","Beast Jeanist","Rui","Senjumaru Shutara"], # Maitre des Fils
    295 : ["Monkey D. Luffy","Baggy","Nico Robin","Wapol","Don Quichotte Doflamingo","Brook","Gecko Moria","Bartholomew Kuma","Jewelry Bonney","Eustass Kid","Trafalgar D. Water Law","Urouge","Boa Hancock","Emporio Ivankov","Inazuma","Edward Newgate","Tsuru","Marshall D. Teach","Fujitora","Don Quichotte Rossinante","Charlotte Linlin","Charlotte Katakuri","Shiryu"], # Paramécia
    ...
    286 : ["Megumi Fushiguro","Satoru Gojo","Ryomen Sukuna","Jogo","Dagon","Mahito","Hiromi Higuruma","Kinji Hakari","Naoya Zenin","Kenjaku","Yuta Okkotsu","Hanami","Yuki Tsukumo"], # Etendeur de Territoire
    ...
    283 : ["Toshiro Hitsugaya","Shuhei Hisagi","Yumichika","Izuru Kira","Rangiku Matsumoto","Shunsui Kyoraku","Isshin Kurosaki","Soi Fon","Kaname Tosen","Mayuri","Rukia Kuchiki","Ginrei Kuchiki"], # Experimenté en Kido
    ...
    273 : ["Kumadori","Kanaria","Nami","Hiruzen Sarutobi","Ener","Yamato","Vados","Whis","Grand Prêtre"], # Utilisateur de Baton A FAIRE
    ...
    252 : ["Monkey D. Luffy","Shanks","Boa Hancock","Silvers Rayleigh","Portgas D. Ace","Edward Newgate","Don Quichotte Doflamingo","Charlotte Linlin","Charlotte Katakuri","Kozuki Oden","Eustass Kid","Sengoku","Kaido","Gol D. Roger","Yamato","Roronoa Zoro","Monkey D. Garp","Topman Warcury"], # Haki Des RoisF
    251 : ["Mahito","Aoi Todo","Nobara Kugisaki","Yuji Itadori","Kento Nanami","Yuta Okkotsu","Satoru Gojo","Ryomen Sukuna"], # Utilisateur du Rayon Noir
    ...
    246 : ["Megumi Fushiguro","Yuji Itadori","Aoi Todo","Maki Zenin","Kinji Hakari","Toge Inumaki","Yuta Okkotsu","Noritoshi Kamo","Kokichi Muta","Nobara Kugisaki","Mai Zenin","Momo Nishimiya","Junpei","Kasumi Miwa","Yu Haibara","Riko Amanai","Josuke Higashikata","Okuyasu Nijimura","Koichi Hirose","Yukako Yamagishi","Momo Yaoyorozu","Izuku Midoriya","Tamaki Amajiki","Shihai Kuroiro","Suguru Geto","Toru Hagakure","Keigo Asano","Kyoka Jiro","Denki Kaminari","Mizuiro Kojima","Yo Shindo","Katsuki Bakugo","Ochaco Uraraka","Ibara Shiozaki","Neito Monoma","Tenya Iida","Shoto Todoroki","Nejire Hado","Panda","Orihime Inoue","Ichigo Kurosaki","Chad","Fumikage Tokoyami","Shinso Hitoshi","Mirio Togata"], # Lyceen
    245 : ["Ryomen Sukuna","Megumi Fushiguro","Sai","Suguru Geto","Kabuto Yakushi","Takuma Ino","Junpei","Akane Sawatari","Orochimaru","Dagon","Kenjaku","Charlotte Linlin","Gecko Moria","Funny Valentine"], # Invocateur
    ...
    237 : ["Itachi Uchiha","Tanjuro Kamado", "Kimimaro","Kaya","Trisha Elric","Jushiro Ukitake","Izumi Curtis","Gol D. Roger","Kokichi Muta","Edward Newgate"], # Maladie Incurable
    ...
    230 : ["Himawari Uzumaki","Hanabi Hyuga","Son Goten","Udo","Gabi Braun","Zofia","Zushi","Falco Grice","Yachiru Kusajishi","Gotenks","Mitsuki","Uub","Karin Kurosaki","Yuzu Kurosaki","Shigechi","Mei Chang","Kon (hxh)","Child Emperor","Sarada Uchiha","Emporio","Eri","Poco","Kiyo","Naho","Anne","Inari","Selim Bradley","Aruka Zoldyck","Gon Freecss","Kirua Zoldyck","Aang"], # Enfant
    ...
    228 : ["Tomura Shigaraki","Pain", "Kuroro Lucifer","Don Quichotte Doflamingo", "Chisaki Kai","Re-Destro","Risotto Nero","Crocodile","Isshiki Otsutsuki","Kurapika","Diavolo","Silva Zoldyck","Giorno Giovanna","Boros"], # Chef d'Organisation criminelle
    ...
    225 : ["Beerus","Champa","Belmod","Père","Athena","Zamasu", "Maitre Kaio", "Kaio Shin", "Goku Black","Toppo","Ener","Drole","Elizabeth Liones","Estarossa","Kaguya Otsutsuki","Super Shenron","Garou"], # Divin
    224 : ["Caesar Clown","Hisoka","Belmod","Baggy"], # Clown
    223 : ["Akaza","Bang","Son Goku","Tortue Geniale","Piccolo","Son Gohan","Vegeta","Hisoka","Maki Zenin","Toji Fushiguro","Rock Lee","Gai Maito","Annie Leonhart","Ling Yao","Shota Aizawa","Garou","Yoruichi Shihoin","Izumi Curtis","Trunks","Soi Fon","Lan Fan","Krilin","Jinbe","Mei Chang","Son Goten","Jonathan Joestar","Caesar Zeppeli","Videl","Cell","Lisa Lisa","Mr. Satan","Fu","Ten Shin Han","Yamcha","Will Zeppeli","Beerus","Pan","Wing","Zushi","Chaozu","Whis","Hit","Jiren","Ryomen Sukuna","Satoru Gojo","C-17","C-18","Sneck","Ty Lee","Gogeta","Vegetto","Genos","Sabo","Shoot","Hack","Azula","Zuko","Orihime Inoue","Emporio Ivankov","Grand Prêtre","Zeno Zoldyck","Doma","Toppo","Dio Brando","Isaac Netero","Vados","Ichigo Kurosaki","Ichibe Hyosube"], # Expert en Art Martial
    ...
    211 : ["Grand Prêtre", "Enrico Pucci","Isaac Netero","Ichibe Hyosube","Gyomei Himejima","Urouge","Uraume","Yahaba","Hidan","Scar","Doma"], # Spirituel
    ...
    206 : ["Riza Hawkeye","Mustard","Miles","Conny Springer","Narancia","Maria Ross","Franklin","Merry","Pakunoda","Kaito","Shepherd Ju Peter","Jean Havoc","Udo","Theo Magath","Rudol Von Stroheim","Genya Shinazugawa","Yelena","Jean Kirstein","Floch","Olivia Mira Armstrong","Shoot","Gaimon","Marcus Mars","Kikyo Zoldyck","Kenny Ackerman","Nejire Hado","Nobara Kugisaki","Gotoh","Jaco","Gol D. Roger","Zombieman","Eustass Kid","Queen","Metal Knight","Kizaru","Irumi Zoldyck","Gyro Zeppeli","Funny Valentine"], # Tireur
    205 : ["Don Krieg","Shaka","Arthur Pendragon","Athena"], # Armure d'Or
    204 : ["Caesar Clown","Don Quichotte Doflamingo","Don Quichotte Rossinante","Vergo"], # Famille Don Quichotte
    203 : ["Caesar Clown","Tim Marcoh","Mayuri","Kisuke Urahara","Hange Zoe","Winry Rockbell","Franky","Child Emperor","Frere De Scar","Bulma","Cioccolata","Kars","Tom Xaver","Edward Elric","Alphonse Elric","Ener","Queen","Metal Knight","Jaygarcia Saturn","Kenjaku"], # Scientifique
    202 : ["Hanami","King (NNT)","Ibara Shiozaki","Hashirama Senju","Tenzo", "Shinji Hirako Nishiya","Danzo Shimura", "Ryokugyu","Kanae Kocho","Kanao Tsuyuri","Shinobu Kocho","Shino Aburame","Asura Otsutsuki","Gloxinia","Naruto Uzumaki","Giorno Giovanna","Kaguya Otsutsuki","Madara Uchiha","Obito Uchiha"], # Maitre de la nature
    201 : ["Escanor","Père","Feitan","Tanjiro Kamado","Sumiyoshi","Tanjuro Kamado","Yoriichi Tsugikuni"], # Pouvoir du soleil
    200 : ["King (NNT)","Gloxinia","Pufu"], # Fée
    199 : ["Stinger","Maki Zenin","King (NNT)","Gloxinia","Power","Angel","Galand","Ulquiorra","Edward Newgate","Ichibe Hyosube"], # Lancier 
    ...
    188 : ["Hidan", "Kakuzu","Sosuke Aizen","Isshiki Otsutsuki","Ban","Kars","Père","Zombieman","Zamasu","Vados","Whis","Muzan Kibutsuji","Ichibe Hyosube"], # Immortel Meliodas ou les homonculus
    187 : ["Jiren", "Champa","Vados","Belmod", "Toppo", "Kefla", "Hit", "Goku Black", "Kale", "Caulifla", "Cabba", "Frost", "Trunks"], # Univers Alternatif
    186 : ["Ryomen Sukuna","Danzo Shimura","Bucciarati","Inazuma","Lust","Kars","Shukuro Tsukishima","Trafalgar D. Water Law","Gin Ichimaru","Edward Newgate"], # Dissecteur
    ...
    168 : ["Daki","Jiraya","Kumadori","Pamu Shiberia","Yukako Yamagishi","Momoshiki Otsutsuki","Kaguya Otsutsuki"], # Manipulateur de cheveux
    167 : ["Itachi Uchiha","Karasu","Mei mei","Shisui Uchiha"], # Maitre des corbeaux
    166 : ["Mount Lady", "Gigantomachia", "Diane","Armin Arlert","Bertholdt Hoover","Rhodes Reiss","Brogy","Dorry","Haguar D. Sauro","Magellan","Laboon","Sloth","Mike","Ryukyu","Choji Akimichi","Gecko Moria","Drole","Re-Destro","Kaido","Charlotte Linlin","Edward Newgate","Eren Yeager"], # Géant
    ...
    163 : ["Zeno Zoldyck","Isaac Netero", "Yamamoto","Tsuru","Monkey D. Garp","Sengoku","Jigoro Kuwajima","Ichibe Hyosube","Iroh","Shunsui Kyoraku","Bang","Jaygarcia Saturn","Marcus Mars","Topman Warcury", "Ethanbaron Nusjuro","Shepherd Ju Peter","Naobito Zenin","Capitaine","Soken Ishida","Pixis","Yoshinobu Gakuganji","Ginrei Kuchiki","Grumman","Hiruzen Sarutobi","Tortue Geniale","Recovery Girl","Gran Torino","Onoki","Hama","Silvers Rayleigh","King Bradley","Toppo","Yhwach","Edward Newgate"], # Vétéran
    162 : ["Kanaria","Gotoh","Whis","Vados","Uraume","Kanae Katagiri","Vanilla Ice","Koruto","Merry","Sumi Nakahara","Kiyo","Naho"], # Serviteur
    161 : ["Diavolo","Twice","Ling Yao","Escanor", "Gogeta","Vegetto","Zamasu","Gotenks","Kefla","All Might","Panda","Coyote Stark","Aruka Zoldyck"], # Double personnalité
    ...
    158 : ["Tompa","Mizuki","Miruki Zoldyck","Guido","Sadaso","Mineta","Cell JR","Majtani","Genthru","Babidi", "Don Krieg","Kuro","Yoki","Pilaf","Akainu"], # Minable et perfide
    157 : ["Alphonse Elric", "Barry The Chopper","Kon","Panda"], # Âme
    156 : ["Weather Report","Nami","Monkey D. Dragon","Arthur Pendragon","Charlotte Linlin"], # Maitre du climat
    ...
    149 : ["Kakashi Hatake","Jiraya","Satoru Gojo","Shota Aizawa","Vlad King","Iruka","Wing","Tortue Geniale","All Might","Snipe","Maitre Kaio","Izumi Curtis","Midnight","Ebisu","Silvers Rayleigh","Dracule Mihawk","Sakonji Urokodaki","Bang","Atomic Samurai","Jigoro Kuwajima","Morel Mackernasey","Utahime Iori","Atsuya Kusakabe","Lisa Lisa","Karin","Kurenai Yuhi","Gai Maito","Mizuki","Konohamaru Sarutobi","Biscuit Kruger","Lady Nagant","Masamichi Yaga","Beast Jeanist","Hiruzen Sarutobi","Asuma Sarutobi","Gran Torino","Hama","Kento Nanami","Gyomei Himejima","Nana Shimura","Kisuke Urahara","Iroh","Merlin","Piccolo","Katara","Monkey D. Garp","Isaac Netero","Whis","Vados","Kishibe"], # Mentor
    148 : ["Glutonny","Majin Buu","Charlotte Linlin","Wapol", "Miruki Zoldyck","Menchi","Todo","Inosuke","Monkey D. Luffy","Son Goku","Sasha Braus","Portgas D. Ace","Choji Akimichi","Hawk","Beerus","Whis","Yajirobe","Polpo","Champa","Appa","Jewelry Bonney"], # Glouton
    147 : ["Shikamaru Nara","Fumikage Tokoyami","Shunsui Kyoraku","Megumi Fushiguro","Shihai Kuroiro","Meliodas","Jiraya","Derrierie","Selim Bradley","Gecko Moria","Estarossa","Marshall D. Teach","Arthur Pendragon"], # Manipulateur de l'ombre
    146 : ["Tim Marcoh", "Neferopito","Tsunade","Sakura Haruno","Ryuken Ishida","Leorio","Shizune","Kabuto Yakushi","Recovery Girl","Karin (naruto)","Josuke Higashikata","Arata Nitta","Fû","Aoi Kanzaki","Kaio Shin","Foo Fighters","Hanataro","Isshin Kurosaki","Asura Otsutsuki","Chopper","Tamayo","Izuru Kira","Maitre Kaio","Orihime Inoue","Emporio Ivankov","Grand Prêtre","Machi","Orochimaru","Marco","Shoko Ieiri","Elizabeth Liones","Trafalgar D. Water Law","Naruto Uzumaki","Hashirama Senju","Katara","Korra","Retsu Unohana","Giorno Giovanna","Yhwach","Vados","Whis","Athena"], # Medecin
    145 : ["Nefertari Vivi","Vegeta","Ling Yao","Elizabeth Liones","Mei Chang","Azula","Yue","Zuko"], # Princesse
    ...
    135 : ["Kankuro", "Sasori","Chiyo","Don Quichotte Doflamingo","Masamichi Yaga","Kokichi Muta","Neferopito","Kuroro Lucifer"], # Marionnettiste
    ...
    133 : ["Ryomen Sukuna", "Meruem", "Yhwach","Zeno","Roi Vegeta","Grand Roi Cold","Dabra","Historia Reiss","Wapol","Cobra","King (NNT)","Zeldris","Gol D. Roger","Emporio Ivankov","Ozai","Zazan","Gloxinia","Nekomamushi","Meliodas","Bartholomew Kuma","Baraggan","Boa Hancock","Drole","Elizabeth Liones","Ban","Arthur Pendragon","Muzan Kibutsuji","Charlotte Linlin"], # Roi
    132 : ["Suguru Geto","Satoru Gojo","Yuki Tsukumo","Yuta Okkotsu","Jogo","Hanami","Dagon","Mahito","Metal Bat","Flashy Flash","Genos","Puri Puri Prisoner","Choso","Zombieman","Deidara","Pain","Orochimaru","Sasori","Itachi Uchiha","Obito Uchiha","Kakuzu","Konan","Kisame","Hidan","Metal Knight","Tatsumaki","Ryomen Sukuna"], # Classe S
    ...
    129 : ["Smoker","Morel Mackernasey","Zabuza Momochi","Muichiro Tokito","Izuku Midoriya","Mei Terumi","Weather Report","Rangiku Matsumoto"], # Maitre du Brouillard
    128 : ["Kaku","Rob Lucci","Kumadori"], # CP-0
    127 : ["Choso","Kechizu", "Katara","Hama","Vlad King","Rui","Noritoshi Kamo","Power","Nezuko Kamado","Esidisi","Eso","Yahaba","Yuji Itadori","Tamayo","Stain","Korra","Retsu Unohana","Muzan Kibutsuji"], # Manipulateur de Sang
    126 : ["Jotaro Kujo","Jolyne Kujo","Holy Kujo"], # Famille Kujo
    125 : ["Zeno", "Rikudo","Père","Athena","Saitama","Super Shenron","Yhwach","Shenron","Aruka Zoldyck","Arthur Pendragon"], # Tout Puissant
    ...
    112 : ["Kuroro Lucifer","All For One","Yhwach", "Neito Monoma","Enrico Pucci","Ging Freecss","Yuta Okkotsu","Makima","Marshall D. Teach","Tomura Shigaraki","Kid Buu","Kugo Ginjo","Kakashi Hatake","Kurapika","Momoshiki Otsutsuki","Kenjaku","Meruem"], # Voleur de Pouvoir
    ...
    102 : ["Beerus","Champa","Belmod","Tomura Shigaraki","Chisaki Kai","Scar","Vanilla Ice","Johnny Joestar","Yamamoto","Grand Prêtre","Zeno","Toppo","Baraggan","Athena"], # Annihilateur
    ...
    91 : ["Edward Elric","Roy Mustang","Solf J. Kimblee","Alex Louis Armstrong","Tim Marcoh","Isaac McDougal","Alphonse Elric","Van Hoheinheim","Père","Scar","Mei Chang","Arthur Pendragon"], # Alchimiste
    90 : [], # Homonculus
    89 : ["Olivia Mira Armstrong","Alex Louis Armstrong"], # Armstrong
    88 : ["Kenjaku","Okuyasu Nijimura","Yuki Tsukumo","Fujitora","Pain","Ochaco Uraraka","Enrico Pucci","Satoru Gojo","Rikudo","Grand Prêtre","Garou"], # Maitre de la Gravite
    ...
    70 : ["Ryomen Sukuna", "Mahito", "Jogo", "Dagon", "Hanami", "Choso","Kechizu"], # Fleaux
    ...
    66 : ["Fujitora","Toph Beifong","Kaname Tosen","Komugi","Shaka","N'Doul","Kagaya Ubuyashiki","Yahaba","Gyomei Himejima","All For One"], # Aveugle 
    65 : ["Minato Namikaze", "Tobirama Senju", "Gran Torino","Sonic","Tenya Iida","Naobito Zenin","Flashy Flash","Shisui Uchiha","Izuku Midoriya","Mirko","Saitama", "Cheetu","Bonolenov Ndongo","Naoya Zenin","Feitan","Kirua Zoldyck","A","Ethanbaron Nusjuro","Jugram","Yoruichi Shihoin","Kizaru","Akaza","Estarossa","Doma","Silva Zoldyck","Charlotte Katakuri","Satoru Gojo","All Might","Isaac Netero","Meruem","Arthur Pendragon","Muzan Kibutsuji","Kokushibo","Garou","Gon Freecss","Boros"], # Monstre de vitesse TODO
    64 : ["Kaido","Ryukyu","Toshiro Hitsugaya","Shenron","Botobai Gigante","Super Shenron","Zeno Zoldyck"], # Draconique TODO  ,"Acnologia","Igneel"
    63 : ["Charlotte Linlin", "Charlotte Katakuri"], # equipage de Charlotte Linlin
    ...
    10 : ["Edward Newgate", "Kaido", "Charlotte Linlin", "Shanks", "Marshall D. Teach","Monkey D. Luffy","Baggy"], # Yonko
    12 : ["Shinji Hirako","Ichigo Kurosaki"], # Vizard
    14 : ["Yamamoto", "Retsu Unohana", "Byakuya Kuchiki", "Kenpachi Zaraki", "Jushiro Ukitake", "Shunsui Kyoraku", "Sajin Komamura", "Mayuri", "Toshiro Hitsugaya", "Rukia Kuchiki","Kisuke Urahara","Yoruichi Shihoin","Ginrei Kuchiki","Isshin Kurosaki","Shinji Hirako","Soi Fon","Kaname Tosen","Gin Ichimaru","Sosuke Aizen"], # Gotei 13
    ...
    28 : ["Naruto Uzumaki", "Killer Bee","Fû", "Yuji Itadori","Madara Uchiha","Obito Uchiha","Gaara","Mito Uzumaki","Kushina Uzumaki","Rikudo","Boruto Uzumaki","Kawaki","Megumi Fushiguro"], # Receptacle TODO
    313 : ["Aang","Korra","Kaguya Otsutsuki","Obito Uchiha","Kakuzu","Orochimaru","Hiruzen Sarutobi","Kakashi Hatake","Momoshiki Otsutsuki","Toneri Otsutsuki","Tobirama Senju","Hashirama Senju","Rikudo","Madara Uchiha"], # Maitre de tous les elements
    29 : ["Portgas D. Ace","Shoto Todoroki", "Sabo", "Iroh", "Zuko", "Ozai", "Azula", "Itachi Uchiha", "Sasuke Uchiha","Jogo","Mohamed Abdul","Dabi","Ryomen Sukuna","Yamamoto","Roy Mustang","Kyojuro Rengoku","Escanor","Sanji","Endeavor","King","Yoriichi Tsugikuni","Merlin","Shisui Uchiha","Izuna Uchiha","Mitsuri Kanroji","Indra Otsutsuki","Hanzo","Danzo Shimura","Meliodas","Jiraya","Onoki","Minato Namikaze","Kawaki"],# Maitre du Feu TODO
    30 : ["Katara", "Suigetsu Hozuki", "Mei Terumi","Kisame","Hama","Halibel","Jinbe","Sakonji Urokodaki","Giyu Tomioka","Sabito","Tanjiro Kamado","Zabuza Momochi","N'Doul","Isaac McDougal","Boruto Uzumaki","Asura Otsutsuki","Konan","Itachi Uchiha","Dagon"], # Maitre de l'Eau TODO
    31 : ["Toph Beifong", "Tenzo","Asura Otsutsuki","Danzo Shimura","Konan","Jiraya","Onoki","Drole","Diane"], # Maitre de la Terre TODO
    32 : ["Temari","Mei Terumi","Danzo Shimura","Boruto Uzumaki","Monkey D. Dragon","Wamuu","All For One","Tomura Shigaraki","Weather Report","Sanemi Shinazugawa","Asura Otsutsuki","Asuma Sarutobi","Konan","Onoki","Minato Namikaze","Naruto Uzumaki","Muzan Kibutsuji","Vados","Whis"], # Maitre de l'Air TODO
    33 : ["Zuko", "Iroh", "Azula", "Ozai", "Kakashi Hatake","Sasuke Uchiha", "Killer Bee", "Darui", "Kakuzu", "Ener","Athena","Denki Kaminari","Zenitsu","Jigoro Kuwajima","Kirua Zoldyck","Yoruichi Shihoin","Akira Otoishi","Boruto Uzumaki","All For One","Tomura Shigaraki","Gilthunder","Lindbergh","Indra Otsutsuki","Toneri Otsutsuki","Hiruzen Sarutobi","Rikudo","Nekomamushi","Onoki","Orochimaru","A","Minato Namikaze","Tobirama Senju","Naruto Uzumaki","Momoshiki Otsutsuki","Hashirama Senju","Madara Uchiha","Charlotte Linlin","Boros"], # Maitre de la foudre TODO
    34 : ["Shoto Todoroki","Aokiji", "Toshiro Hitsugaya", "Rukia Kuchiki","Natsuo Todoroki","Fuyumi Todoroki","Rei Todoroki", "Uraume","Haku","Isaac McDougal","Ghiaccio","Katara","Doma","Korra","Kaguya Otsutsuki"], # Maitre de la Glace TODO Gray Fullbuster

    36 : ["Akainu", "Jogo","Mei Terumi","Onoki"], # Maitre de la Lave TODO
    39 : ["Gaara","Iggy","Crocodile","Sajin Higawara","Ganju Shiba","Toph Beifong","Onoki"], # Maitre du Sable 
    40 : ["Roronoa Zoro", "Dracule Mihawk","Toji Fushiguro","Maki Zenin", "Killer Bee", "Tashigi", "Kaku", "Sasuke Uchiha","Kisame", "Suigetsu Hozuki", "Zabuza Momochi","Shanks", "Gol D. Roger", "Stain", "Ichigo Kurosaki", "Sosuke Aizen", "Kenpachi Zaraki", "Retsu Unohana", "Gin Ichimaru", "Darui", "Yamamoto", "Trunks", "Tapion", "Son Gohan", "Rukia Kuchiki", "Byakuya Kuchiki", "Kozuki Oden", "Trafalgar D. Water Law", "Brook","Fujitora","Shiryu", "Yhwach","Haruta Shigemo","Yugao Uzuki","Ling Yao","Halibel","Yajirobe","Kasumi Miwa","Spinner","Hatchan","Inazuma","Dorry","Tengen Uzui","Dabra","Meliodas", "Eren Yeager", "Mikasa Ackerman", "Armin Arlert", "Levi Ackerman", "Hange Zoe", "Erwin Smith", "Jean Kirstein", "Conny Springer", "Sasha Braus", "Historia Reiss", "Ymir", "Reiner Braun", "Mike Zacharias","Zeldris","Gilthunder","Katana Man","Shimotsuki Kuina","Sakonji Urokodaki","Sabito","Shunsui Kyoraku","Coyote Stark","Kisuke Urahara","Barry The Chopper","Ganju Shiba","King","Jushiro Ukitake","Jean-Pierre Polnareff","Atomic Samurai","Kaito","Ryokugyu","Muichiro Tokito","Yoriichi Tsugikuni","Tanjuro Kamado","Kimimaro","Atsuya Kusakabe","Yachiru Kusajishi","Zenitsu","Genya Shinazugawa","Giyu Tomioka","Flashy Flash","Shisui Uchiha","Jugram","Hiromi Higuruma","Yuta Okkotsu","Izuna Uchiha","Sokka","Kyojuro Rengoku","Ozaki","Sajin Komamura","Kanao Tsuyuri","Olivia Mira Armstrong","Grand Roi Cold","Shinobu Kocho","Mitsuri Kanroji","Hanataro","Inosuke","Sanemi Shinazugawa","Hendrickson","Isshin Kurosaki","Indra Otsutsuki","Asura Otsutsuki","Yumichika","Shuhei Hisagi","Mayuri","Danzo Shimura","Izuru Kira","Murata","Shinji Hirako","Sonic","Shukuro Tsukishima","Kugo Ginjo","Kaname Tosen","Angel","Nobunaga","Grimmjow","Feitan","Kento Nanami","Orochimaru","Kanae Kocho","Renji Abarai","Rangiku Matsumoto","Gecko Moria","Mahoraga","Ethanbaron Nusjuro","Yoruichi Shihoin","Vegetto","Kizaru","Silvers Rayleigh","Ulquiorra","Estarossa","Toshiro Hitsugaya","Arthur Pendragon","Rikudo","Kokushibo","Charlotte Linlin","Ichibe Hyosube","Tanjiro Kamado"], # epeiste Cavendish
    41 : ["Fubuki","Tatsumaki","Himeno","Majin Buu","Babidi","Kaio Shin","Grand Roi Cold","Ginyu","Maitre Kaio","Whis","Vados","Grand Prêtre","Athena","Beerus","Champa"], # Telekinesiste
    ...
    53 : ["Dio Brando","Diavolo", "Jotaro Kujo","Nighteye","Kira Yoshikage","Enrico Pucci","Charlotte Katakuri","Athena","Boingo","Neon Nostrad","Hit","Eri","Baraggan","Jugram","Yhwach","Momoshiki Otsutsuki","Grand Prêtre","Whis","Vados","Diego Brando","Zamasu","Arthur Pendragon","Garou"], # Maitre du Temps
...
all_techniques = {
    ...
    "Ryomen Sukuna" : [
        ["Trancher Ryomen Sukuna", "utilise", "https://i.imgur.com/Kr5pygu.gif", "#040404"],
    ...
    "Kuroro Lucifer" : [
        ...
        ["Fun Fun Cloth", "lance", "https://media1.tenor.com/m/rEZ8H21smUAAAAAd/chrollo-lucilfer-chrollo.gif", "#7e1f4b"],
        ["Nen", "utilise son", "https://media1.tenor.com/m/gu7GDy0btqkAAAAC/chrollo-lucilfer-hunter-x-hunter.gif", "#999c82"],
    ...
    #AUTRES
    "Moshi" : [
        ["Miaule", "", "https://media1.tenor.com/m/lIDWDPQpyf0AAAAC/meow-cats.gif", "#b1f1e3"],
        ["Rugit", "", "https://media1.tenor.com/m/lX4SEdrhJD4AAAAd/httyd-toothless.gif", "#29cdfa"],
        ["Sourit", "", "https://media1.tenor.com/m/qdT1lygmdfkAAAAC/little-black-cat-cat.gif", "#9bbfb4"],
        ["Marche", "", "https://media1.tenor.com/m/GJygKW_CrY0AAAAd/kikis-delivery-service-anime.gif", "#9bbfb4"],
